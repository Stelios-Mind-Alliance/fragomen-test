...
export type Theme = 'iams-default' | 'iams-light' | 'iams-dark' | 'iams-flat';
  ...
  setStyle(style: 'default' | 'flat' | 'dark' | 'light' | 'top' | string) {
    switch (style) {
      case 'flat': {
        ...
        this.setTheme('iams-flat');
        break;
      }

      case 'dark': {
        this.setTheme('iams-dark');
        break;
      }
