...
@Directive({
  selector: '[iamsSidebar],iams-sidebar',
  host: {
    class: 'iams-sidebar',
  },
  exportAs: 'iamsSidebar',
})
export class SidebarDirective implements AfterViewInit, OnDestroy {
  ...
  enableScrollblock() {
    this.document.body.classList.add('iams-scrollblock');
  }

  disableScrollblock() {
    this.document.body.classList.remove('iams-scrollblock');
  }
