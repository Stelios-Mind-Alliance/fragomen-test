...
import { fadeInRightAnimation } from '../../../../@iams/animations/fade-in-right.animation';
import { scaleInAnimation } from '../../../../@iams/animations/scale-in.animation';
import { fadeInUpAnimation } from '../../../../@iams/animations/fade-in-up.animation';

@Component({
  selector: 'iams-form-wizard',
